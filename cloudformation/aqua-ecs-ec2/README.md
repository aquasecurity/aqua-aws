[![Launch Stack](https://s3.amazonaws.com/cloudformation-examples/cloudformation-launch-stack.png)](https://console.aws.amazon.com/cloudformation/home?#/stacks/new?stackName=aqua-ecs&templateURL=https://s3.amazonaws.com/aqua-security-public/{{ version }}/aquaEcs.yaml)
...
2. Pull the Aqua product images for the Server (Console), Gateway and Aqua Enforcer with these commands. 
   ...
   docker pull registry.aquasec.com/enforcer:6.2.RC1
   ```
...
2. Pull the Aqua Scanner image. 
   ```
   docker pull registry.aquasec.com/scanner:6.2.RC1
   ```
